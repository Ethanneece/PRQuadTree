...
public class Rectangle implements Comparable<Rectangle>
{
    ...
    public Rectangle[] splitIntoRegions()
	{
		Rectangle[] rectangles = new Rectangle[4];

		rectangles[0] = new Rectangle(this.x, this.y, this.w/2, this.h/2);
		rectangles[1] = new Rectangle(this.x + this.w/2, 0, this.w/2, this.h/2);
		rectangles[2] = new Rectangle(this.x, this.y + this.h/2, this.w/2, this.h/2);
		rectangles[3] = new Rectangle(this.x + this.w/2, this.y + this.h/2, this.w/2, this.h/2);
	...
	public boolean contains(Point p)
    {
        ...
        if (this.x + this.w < p.getX() || this.y + this.h < p.getY())
        {
            return false;
        }
